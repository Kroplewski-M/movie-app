<template>
    <section class=" w-[100%] h-[270vh] md:h-[110vh] bg-[#121212] text-green-400">
        <router-link to="/"><img src="@/resources/back.png" alt="" class="w-[50px] h-[50px] ml-5 mt-[20px] absolute"></router-link>
        <div class="md:w-[1500px] md:h-[1000px] mx-auto pt-[80px] pl-5">
            <div class="w-[100%] md:h-[750px] h-[auto] bg-[#232323] rounded-md">
                ...
                <p class="mt-[50px] float-left text-green-500">Release date: <span class="font-bold mr-5 md:mr-5">{{this.movieRelease}}</span></p>
                ...
                <p class="font-bold float-left mt-[90px] text-green-500 text-[30px] w-[100%] md:w-[800px]">Description:</p>
                <p class="float-left w-[300px] md:w-[700px] mt-[20px] text-[17px] text-green-500 italic pb-10 md:pb-0 block">{{this.movieDesc}}</p>
            </div>
        </div>
    </section>
</template>
